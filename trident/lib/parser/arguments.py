...
class TridentArgumentParser:
    ...
    def _setup_parser(self) -> ArgumentParser:
        ...
        parser = ArgumentParser(
            prog="Trident", description="Trident: Asynchronous Monitor Environment"
        )
        return parser
    ...
    def _collect_optional_arguments(self) -> NoReturn:
        ...
        logging_group.add_argument(
            ...
            "--verbose",
            action="store_true",
            help="Enable verbose logging for Trident.",
            default=None,
        )
        logging_group.add_argument(
            "-q",
            "--quiet",
            action="store_true",
            help="Disables all logging for Trident.",
            default=None,
        )
        ...
        group.add_argument(
            "-w",
            "--workers",
            type=self._valid_positive_integer,
    ...
    def _collect_plugin_arguments(self) -> NoReturn:
        ...
        group.add_argument(
            "-p:n", "--dont-store-on-error", action="store_true", default=None
        )
        group.add_argument(
    ...
    def _collect_storage_arguments(self) -> NoReturn:
        ...
        group.add_argument(
            ...
            "--no-store",
            action="store_true",
            help="Disables all storage of results generated by Trident plugins.",
            default=None,
        )
        group.add_argument(
            "-s:g",
    ...
    def _collect_required_arguments(self) -> NoReturn:
        ...
        group.add_argument(
            "-c",
            "--config",
            help="Trident Config File. Defaults to './config/trident.json'",
            default="config/trident.json",
        )
        group.add_argument(
            "-c:s",
            "--section",
